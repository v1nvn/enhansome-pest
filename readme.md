...
* [Vector](https://github.com/timberio/vector) ⭐ 21,755 | 🐛 2,439 | 🌐 Rust | 📅 2026-05-02 - A high-performance observability data pipeline.
...
* [tera](https://github.com/Keats/tera) ⭐ 4,196 | 🐛 193 | 🌐 Rust | 📅 2026-04-03 - A template engine for Rust based on Jinja2/Django.
* [insta](https://github.com/mitsuhiko/insta) ⭐ 2,840 | 🐛 75 | 🌐 Rust | 📅 2026-03-30 - A snapshot testing library for rust.
...
* [AutoCorrect](https://github.com/huacnlee/autocorrect) ⭐ 1,584 | 🐛 10 | 🌐 Rust | 📅 2026-04-14 - A linter and formatter to help you to improve copywriting, correct spaces, words, and punctuations between CJK (Chinese, Japanese, Korean).
* [handlebars-rust](https://github.com/sunng87/handlebars-rust) ⭐ 1,471 | 🐛 41 | 🌐 Rust | 📅 2026-04-14 - Rust templating with Handlebars.
* [cicada](https://github.com/mitnk/cicada) ⭐ 1,002 | 🐛 0 | 🌐 Rust | 📅 2026-04-23 - An old-school bash-like Unix shell written in Rust.
...
* [TypeQL Rust](https://github.com/typedb/typeql/tree/master/rust) ⭐ 250 | 🐛 45 | 🌐 Rust | 📅 2026-05-01 - TypeDB's query language, written in Pest
...
* [Keadex Mina](https://github.com/keadex/keadex) ⭐ 198 | 🐛 0 | 🌐 TypeScript | 📅 2026-05-01 - Open Source, serverless IDE to code with C4-PlantUML and organize at a scale C4 model diagrams.
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,528 | 🐛 233 | 🌐 Python | 📅 2026-05-01, [Ledger](https://github.com/ledger/ledger) ⭐ 5,919 | 🐛 4 | 🌐 C++ | 📅 2026-05-01, and other PTA formats.
