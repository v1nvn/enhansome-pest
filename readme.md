...
[<img src="https://avatars.githubusercontent.com/u/26044607" align="right" width="100">](https://github.com/pest-parser/pest/) ⭐ 5,317 | 🐛 69 | 🌐 Rust | 📅 2026-03-18
...
* [GitHub Discussions](https://github.com/pest-parser/pest/discussions) ⭐ 5,317 | 🐛 69 | 🌐 Rust | 📅 2026-03-18

## Projects

Here are some example projects using pest:

* [Vector](https://github.com/timberio/vector) ⭐ 21,571 | 🐛 2,375 | 🌐 Rust | 📅 2026-04-01 - A high-performance observability data pipeline.
* [pest\_meta](https://github.com/pest-parser/pest/blob/master/meta/src/grammar.pest) ⭐ 5,317 | 🐛 69 | 🌐 Rust | 📅 2026-03-18 - The pest itself is bootstrapped using pest.
...
* [tera](https://github.com/Keats/tera) ⭐ 4,167 | 🐛 193 | 🌐 Rust | 📅 2025-12-11 - A template engine for Rust based on Jinja2/Django.
* [insta](https://github.com/mitsuhiko/insta) ⭐ 2,812 | 🐛 70 | 🌐 Rust | 📅 2026-03-30 - A snapshot testing library for rust.
* [ZoKrates](https://github.com/ZoKrates/ZoKrates) ⭐ 1,882 | 🐛 110 | 🌐 Rust | 📅 2024-08-01 - A toolbox for zkSNARKs on Ethereum.
* [jql](https://github.com/yamafaktory/jql) ⭐ 1,665 | 🐛 2 | 🌐 Rust | 📅 2026-03-18 - A JSON Query Language CLI tool.
* [AutoCorrect](https://github.com/huacnlee/autocorrect) ⭐ 1,576 | 🐛 9 | 🌐 Rust | 📅 2026-03-23 - A linter and formatter to help you to improve copywriting, correct spaces, words, and punctuations between CJK (Chinese, Japanese, Korean).
* [handlebars-rust](https://github.com/sunng87/handlebars-rust) ⭐ 1,463 | 🐛 42 | 🌐 Rust | 📅 2026-03-29 - Rust templating with Handlebars.
* [cicada](https://github.com/mitnk/cicada) ⭐ 1,005 | 🐛 0 | 🌐 Rust | 📅 2026-03-26 - An old-school bash-like Unix shell written in Rust.
* [rs\_pbrt](https://github.com/wahn/rs_pbrt) ⭐ 835 | 🐛 3 | 🌐 Rust | 📅 2024-01-29 - Rust crate to implement a counterpart to the PBRT book's (3rd edition) C++ code.
* [TypeQL Rust](https://github.com/typedb/typeql/tree/master/rust) ⭐ 250 | 🐛 46 | 🌐 Rust | 📅 2026-03-26 - TypeDB's query language, written in Pest
* [json5-rs](https://github.com/callum-oakley/json5-rs) ⭐ 231 | 🐛 4 | 🌐 Rust | 📅 2026-02-07 - A Rust JSON5 serializer and deserializer which speaks Serde.
* [Keadex Mina](https://github.com/keadex/keadex) ⭐ 197 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-19 - Open Source, serverless IDE to code with C4-PlantUML and organize at a scale C4 model diagrams.
* [qubit](https://github.com/abhimanyu003/qubit) ⭐ 97 | 🐛 1 | 🌐 Rust | 📅 2022-01-17 - A handy calculator, based on Rust and WebAssembly.
...
* [mt940](https://github.com/svenstaro/mt940-rs) ⭐ 27 | 🐛 0 | 🌐 Rust | 📅 2026-03-01 - A MT940 parser in Rust.
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,425 | 🐛 230 | 🌐 Python | 📅 2026-03-23, [Ledger](https://github.com/ledger/ledger) ⭐ 5,901 | 🐛 221 | 🌐 C++ | 📅 2026-03-31, and other PTA formats.
...
* [pest IDE tools](https://github.com/pest-parser/pest-ide-tools) ⭐ 66 | 🐛 18 | 🌐 Rust | 📅 2026-03-30 - A main repository with LSP server and VSCode extension.
...
* [pest-ast](https://github.com/pest-parser/ast) ⭐ 93 | 🐛 20 | 🌐 Rust | 📅 2025-12-26 - It can help to reduce boilerplate when converting pest parse trees to abstract syntax trees.
