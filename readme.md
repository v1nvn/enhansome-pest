...
* [Vector](https://github.com/timberio/vector) ⭐ 21,727 | 🐛 2,433 | 🌐 Rust | 📅 2026-04-28 - A high-performance observability data pipeline.
...
* [tera](https://github.com/Keats/tera) ⭐ 4,190 | 🐛 193 | 🌐 Rust | 📅 2026-04-03 - A template engine for Rust based on Jinja2/Django.
* [insta](https://github.com/mitsuhiko/insta) ⭐ 2,835 | 🐛 75 | 🌐 Rust | 📅 2026-03-30 - A snapshot testing library for rust.
...
* [handlebars-rust](https://github.com/sunng87/handlebars-rust) ⭐ 1,468 | 🐛 41 | 🌐 Rust | 📅 2026-04-14 - Rust templating with Handlebars.
...
* [TypeQL Rust](https://github.com/typedb/typeql/tree/master/rust) ⭐ 250 | 🐛 44 | 🌐 Rust | 📅 2026-04-23 - TypeDB's query language, written in Pest
...
* [Keadex Mina](https://github.com/keadex/keadex) ⭐ 198 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-27 - Open Source, serverless IDE to code with C4-PlantUML and organize at a scale C4 model diagrams.
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,512 | 🐛 232 | 🌐 Python | 📅 2026-04-18, [Ledger](https://github.com/ledger/ledger) ⭐ 5,916 | 🐛 1 | 🌐 C++ | 📅 2026-04-28, and other PTA formats.
...
* [pest IDE tools](https://github.com/pest-parser/pest-ide-tools) ⭐ 67 | 🐛 23 | 🌐 Rust | 📅 2026-04-27 - A main repository with LSP server and VSCode extension.
