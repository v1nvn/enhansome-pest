...
* [Vector](https://github.com/timberio/vector) ⭐ 21,288 | 🐛 2,253 | 🌐 Rust | 📅 2026-02-07 - A high-performance observability data pipeline.
...
* [insta](https://github.com/mitsuhiko/insta) ⭐ 2,739 | 🐛 70 | 🌐 Rust | 📅 2026-02-05 - A snapshot testing library for rust.
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,244 | 🐛 226 | 🌐 Python | 📅 2026-01-30, [Ledger](https://github.com/ledger/ledger) ⭐ 5,825 | 🐛 739 | 🌐 C++ | 📅 2026-02-06, and other PTA formats.
...
* [pest IDE tools](https://github.com/pest-parser/pest-ide-tools) ⭐ 64 | 🐛 19 | 🌐 Rust | 📅 2026-02-03 - A main repository with LSP server and VSCode extension.
