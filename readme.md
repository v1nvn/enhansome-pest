...
[<img src="https://avatars.githubusercontent.com/u/26044607" align="right" width="100">](https://github.com/pest-parser/pest/) ⭐ 5,309 | 🐛 69 | 🌐 Rust | 📅 2026-02-05
...
* [GitHub Discussions](https://github.com/pest-parser/pest/discussions) ⭐ 5,309 | 🐛 69 | 🌐 Rust | 📅 2026-02-05

## Projects

Here are some example projects using pest:

* [Vector](https://github.com/timberio/vector) ⭐ 21,478 | 🐛 2,343 | 🌐 Rust | 📅 2026-03-14 - A high-performance observability data pipeline.
* [pest\_meta](https://github.com/pest-parser/pest/blob/master/meta/src/grammar.pest) ⭐ 5,309 | 🐛 69 | 🌐 Rust | 📅 2026-02-05 - The pest itself is bootstrapped using pest.
...
* [jql](https://github.com/yamafaktory/jql) ⭐ 1,659 | 🐛 3 | 🌐 Rust | 📅 2026-02-03 - A JSON Query Language CLI tool.
...
* [handlebars-rust](https://github.com/sunng87/handlebars-rust) ⭐ 1,458 | 🐛 42 | 🌐 Rust | 📅 2026-03-07 - Rust templating with Handlebars.
...
* [TypeQL Rust](https://github.com/typedb/typeql/tree/master/rust) ⭐ 247 | 🐛 44 | 🌐 Rust | 📅 2026-03-13 - TypeDB's query language, written in Pest
* [json5-rs](https://github.com/callum-oakley/json5-rs) ⭐ 228 | 🐛 4 | 🌐 Rust | 📅 2026-02-07 - A Rust JSON5 serializer and deserializer which speaks Serde.
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,373 | 🐛 228 | 🌐 Python | 📅 2026-01-30, [Ledger](https://github.com/ledger/ledger) ⭐ 5,876 | 🐛 304 | 🌐 C++ | 📅 2026-03-15, and other PTA formats.
