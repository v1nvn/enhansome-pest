...
* [Vector](https://github.com/timberio/vector) ⭐ 21,616 | 🐛 2,376 | 🌐 Rust | 📅 2026-04-08 - A high-performance observability data pipeline.
...
* [tera](https://github.com/Keats/tera) ⭐ 4,174 | 🐛 193 | 🌐 Rust | 📅 2026-04-03 - A template engine for Rust based on Jinja2/Django.
* [insta](https://github.com/mitsuhiko/insta) ⭐ 2,817 | 🐛 71 | 🌐 Rust | 📅 2026-03-30 - A snapshot testing library for rust.
...
* [handlebars-rust](https://github.com/sunng87/handlebars-rust) ⭐ 1,463 | 🐛 41 | 🌐 Rust | 📅 2026-04-04 - Rust templating with Handlebars.
* [cicada](https://github.com/mitnk/cicada) ⭐ 1,003 | 🐛 0 | 🌐 Rust | 📅 2026-03-26 - An old-school bash-like Unix shell written in Rust.
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,437 | 🐛 230 | 🌐 Python | 📅 2026-03-23, [Ledger](https://github.com/ledger/ledger) ⭐ 5,903 | 🐛 183 | 🌐 C++ | 📅 2026-04-09, and other PTA formats.
