...
* [Vector](https://github.com/timberio/vector) ⭐ 21,722 | 🐛 2,408 | 🌐 Rust | 📅 2026-04-25 - A high-performance observability data pipeline.
...
* [insta](https://github.com/mitsuhiko/insta) ⭐ 2,833 | 🐛 75 | 🌐 Rust | 📅 2026-03-30 - A snapshot testing library for rust.
...
* [AutoCorrect](https://github.com/huacnlee/autocorrect) ⭐ 1,582 | 🐛 10 | 🌐 Rust | 📅 2026-04-14 - A linter and formatter to help you to improve copywriting, correct spaces, words, and punctuations between CJK (Chinese, Japanese, Korean).
* [handlebars-rust](https://github.com/sunng87/handlebars-rust) ⭐ 1,467 | 🐛 41 | 🌐 Rust | 📅 2026-04-14 - Rust templating with Handlebars.
...
* [Keadex Mina](https://github.com/keadex/keadex) ⭐ 198 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-26 - Open Source, serverless IDE to code with C4-PlantUML and organize at a scale C4 model diagrams.
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,509 | 🐛 232 | 🌐 Python | 📅 2026-04-18, [Ledger](https://github.com/ledger/ledger) ⭐ 5,916 | 🐛 13 | 🌐 C++ | 📅 2026-04-27, and other PTA formats.
