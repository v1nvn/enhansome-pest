...
* [Vector](https://github.com/timberio/vector) ⭐ 21,482 | 🐛 2,345 | 🌐 Rust | 📅 2026-03-14 - A high-performance observability data pipeline.
...
* [tera](https://github.com/Keats/tera) ⭐ 4,154 | 🐛 192 | 🌐 Rust | 📅 2025-12-11 - A template engine for Rust based on Jinja2/Django.
...
* [TypeQL Rust](https://github.com/typedb/typeql/tree/master/rust) ⭐ 248 | 🐛 44 | 🌐 Rust | 📅 2026-03-13 - TypeDB's query language, written in Pest
* [json5-rs](https://github.com/callum-oakley/json5-rs) ⭐ 229 | 🐛 4 | 🌐 Rust | 📅 2026-02-07 - A Rust JSON5 serializer and deserializer which speaks Serde.
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,376 | 🐛 228 | 🌐 Python | 📅 2026-01-30, [Ledger](https://github.com/ledger/ledger) ⭐ 5,878 | 🐛 294 | 🌐 C++ | 📅 2026-03-15, and other PTA formats.
...
* [pest IDE tools](https://github.com/pest-parser/pest-ide-tools) ⭐ 64 | 🐛 15 | 🌐 Rust | 📅 2026-03-16 - A main repository with LSP server and VSCode extension.
