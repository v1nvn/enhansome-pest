...
* [Vector](https://github.com/timberio/vector) ⭐ 21,337 | 🐛 2,282 | 🌐 Rust | 📅 2026-02-17 - A high-performance observability data pipeline.
...
* [tera](https://github.com/Keats/tera) ⭐ 4,120 | 🐛 192 | 🌐 Rust | 📅 2025-12-11 - A template engine for Rust based on Jinja2/Django.
...
* [handlebars-rust](https://github.com/sunng87/handlebars-rust) ⭐ 1,452 | 🐛 42 | 🌐 Rust | 📅 2026-02-14 - Rust templating with Handlebars.
...
* [Keadex Mina](https://github.com/keadex/keadex) ⭐ 194 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-18 - Open Source, serverless IDE to code with C4-PlantUML and organize at a scale C4 model diagrams.
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,284 | 🐛 226 | 🌐 Python | 📅 2026-01-30, [Ledger](https://github.com/ledger/ledger) ⭐ 5,843 | 🐛 555 | 🌐 C++ | 📅 2026-02-17, and other PTA formats.
