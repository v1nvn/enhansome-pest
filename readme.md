...
[<img src="https://avatars.githubusercontent.com/u/26044607" align="right" width="100">](https://github.com/pest-parser/pest/) ⭐ 5,274 | 🐛 68 | 🌐 Rust | 📅 2026-02-05
...
* [GitHub Discussions](https://github.com/pest-parser/pest/discussions) ⭐ 5,274 | 🐛 68 | 🌐 Rust | 📅 2026-02-05

## Projects

Here are some example projects using pest:

* [Vector](https://github.com/timberio/vector) ⭐ 21,287 | 🐛 2,252 | 🌐 Rust | 📅 2026-02-07 - A high-performance observability data pipeline.
* [pest\_meta](https://github.com/pest-parser/pest/blob/master/meta/src/grammar.pest) ⭐ 5,274 | 🐛 68 | 🌐 Rust | 📅 2026-02-05 - The pest itself is bootstrapped using pest.
...
* [tera](https://github.com/Keats/tera) ⭐ 4,117 | 🐛 192 | 🌐 Rust | 📅 2025-12-11 - A template engine for Rust based on Jinja2/Django.
* [insta](https://github.com/mitsuhiko/insta) ⭐ 2,737 | 🐛 70 | 🌐 Rust | 📅 2026-02-05 - A snapshot testing library for rust.
* [ZoKrates](https://github.com/ZoKrates/ZoKrates) ⭐ 1,881 | 🐛 109 | 🌐 Rust | 📅 2024-08-01 - A toolbox for zkSNARKs on Ethereum.
* [jql](https://github.com/yamafaktory/jql) ⭐ 1,651 | 🐛 3 | 🌐 Rust | 📅 2026-02-03 - A JSON Query Language CLI tool.
* [AutoCorrect](https://github.com/huacnlee/autocorrect) ⭐ 1,539 | 🐛 6 | 🌐 Rust | 📅 2026-02-05 - A linter and formatter to help you to improve copywriting, correct spaces, words, and punctuations between CJK (Chinese, Japanese, Korean).
...
* [TypeQL Rust](https://github.com/typedb/typeql/tree/master/rust) ⭐ 242 | 🐛 42 | 🌐 Rust | 📅 2026-02-04 - TypeDB's query language, written in Pest
* [json5-rs](https://github.com/callum-oakley/json5-rs) ⭐ 223 | 🐛 4 | 🌐 Rust | 📅 2025-12-21 - A Rust JSON5 serializer and deserializer which speaks Serde.
* [Keadex Mina](https://github.com/keadex/keadex) ⭐ 194 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-06 - Open Source, serverless IDE to code with C4-PlantUML and organize at a scale C4 model diagrams.
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,239 | 🐛 226 | 🌐 Python | 📅 2026-01-30, [Ledger](https://github.com/ledger/ledger) ⭐ 5,825 | 🐛 739 | 🌐 C++ | 📅 2026-02-06, and other PTA formats.
...
* [pest IDE tools](https://github.com/pest-parser/pest-ide-tools) ⭐ 63 | 🐛 19 | 🌐 Rust | 📅 2026-02-03 - A main repository with LSP server and VSCode extension.
