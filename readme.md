...
[<img src="https://avatars.githubusercontent.com/u/26044607" align="right" width="100">](https://github.com/pest-parser/pest/) ⭐ 5,329 | 🐛 69 | 🌐 Rust | 📅 2026-03-18
...
* [GitHub Discussions](https://github.com/pest-parser/pest/discussions) ⭐ 5,329 | 🐛 69 | 🌐 Rust | 📅 2026-03-18

## Projects

Here are some example projects using pest:

* [Vector](https://github.com/timberio/vector) ⭐ 21,662 | 🐛 2,393 | 🌐 Rust | 📅 2026-04-17 - A high-performance observability data pipeline.
* [pest\_meta](https://github.com/pest-parser/pest/blob/master/meta/src/grammar.pest) ⭐ 5,329 | 🐛 69 | 🌐 Rust | 📅 2026-03-18 - The pest itself is bootstrapped using pest.
* [Melody](https://github.com/yoav-lavi/melody) ⭐ 4,746 | 🐛 8 | 🌐 Rust | 📅 2024-11-24 - Melody is a language that compiles to regular expressions and aims to be more easily readable and maintainable.
* [tera](https://github.com/Keats/tera) ⭐ 4,181 | 🐛 195 | 🌐 Rust | 📅 2026-04-03 - A template engine for Rust based on Jinja2/Django.
* [insta](https://github.com/mitsuhiko/insta) ⭐ 2,826 | 🐛 73 | 🌐 Rust | 📅 2026-03-30 - A snapshot testing library for rust.
* [ZoKrates](https://github.com/ZoKrates/ZoKrates) ⭐ 1,880 | 🐛 110 | 🌐 Rust | 📅 2024-08-01 - A toolbox for zkSNARKs on Ethereum.
* [jql](https://github.com/yamafaktory/jql) ⭐ 1,669 | 🐛 2 | 🌐 Rust | 📅 2026-03-18 - A JSON Query Language CLI tool.
* [AutoCorrect](https://github.com/huacnlee/autocorrect) ⭐ 1,580 | 🐛 10 | 🌐 Rust | 📅 2026-04-14 - A linter and formatter to help you to improve copywriting, correct spaces, words, and punctuations between CJK (Chinese, Japanese, Korean).
* [handlebars-rust](https://github.com/sunng87/handlebars-rust) ⭐ 1,465 | 🐛 41 | 🌐 Rust | 📅 2026-04-14 - Rust templating with Handlebars.
* [cicada](https://github.com/mitnk/cicada) ⭐ 1,002 | 🐛 0 | 🌐 Rust | 📅 2026-03-26 - An old-school bash-like Unix shell written in Rust.
...
* [TypeQL Rust](https://github.com/typedb/typeql/tree/master/rust) ⭐ 250 | 🐛 43 | 🌐 Rust | 📅 2026-04-15 - TypeDB's query language, written in Pest
...
* [Keadex Mina](https://github.com/keadex/keadex) ⭐ 198 | 🐛 0 | 🌐 TypeScript | 📅 2026-04-16 - Open Source, serverless IDE to code with C4-PlantUML and organize at a scale C4 model diagrams.
...
* [mt940](https://github.com/svenstaro/mt940-rs) ⭐ 27 | 🐛 1 | 🌐 Rust | 📅 2026-04-10 - A MT940 parser in Rust.
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,470 | 🐛 232 | 🌐 Python | 📅 2026-04-12, [Ledger](https://github.com/ledger/ledger) ⭐ 5,910 | 🐛 84 | 🌐 C++ | 📅 2026-04-17, and other PTA formats.
...
* [pest IDE tools](https://github.com/pest-parser/pest-ide-tools) ⭐ 66 | 🐛 22 | 🌐 Rust | 📅 2026-04-15 - A main repository with LSP server and VSCode extension.
