...
* [Vector](https://github.com/timberio/vector) ⭐ 21,732 | 🐛 2,432 | 🌐 Rust | 📅 2026-04-29 - A high-performance observability data pipeline.
...
* [TypeQL Rust](https://github.com/typedb/typeql/tree/master/rust) ⭐ 250 | 🐛 44 | 🌐 Rust | 📅 2026-04-28 - TypeDB's query language, written in Pest
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,519 | 🐛 232 | 🌐 Python | 📅 2026-04-29, [Ledger](https://github.com/ledger/ledger) ⭐ 5,917 | 🐛 4 | 🌐 C++ | 📅 2026-04-28, and other PTA formats.
