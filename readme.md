...
[<img src="https://avatars.githubusercontent.com/u/26044607" align="right" width="100">](https://github.com/pest-parser/pest/) ⭐ 5,309 | 🐛 70 | 🌐 Rust | 📅 2026-02-05
...
* [GitHub Discussions](https://github.com/pest-parser/pest/discussions) ⭐ 5,309 | 🐛 70 | 🌐 Rust | 📅 2026-02-05

## Projects

Here are some example projects using pest:

* [Vector](https://github.com/timberio/vector) ⭐ 21,485 | 🐛 2,343 | 🌐 Rust | 📅 2026-03-16 - A high-performance observability data pipeline.
* [pest\_meta](https://github.com/pest-parser/pest/blob/master/meta/src/grammar.pest) ⭐ 5,309 | 🐛 70 | 🌐 Rust | 📅 2026-02-05 - The pest itself is bootstrapped using pest.
...
* [tera](https://github.com/Keats/tera) ⭐ 4,155 | 🐛 192 | 🌐 Rust | 📅 2025-12-11 - A template engine for Rust based on Jinja2/Django.
...
* [TypeQL Rust](https://github.com/typedb/typeql/tree/master/rust) ⭐ 248 | 🐛 44 | 🌐 Rust | 📅 2026-03-16 - TypeDB's query language, written in Pest
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,381 | 🐛 229 | 🌐 Python | 📅 2026-01-30, [Ledger](https://github.com/ledger/ledger) ⭐ 5,880 | 🐛 294 | 🌐 C++ | 📅 2026-03-15, and other PTA formats.
