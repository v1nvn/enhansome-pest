...
* [Vector](https://github.com/timberio/vector) ⭐ 21,551 | 🐛 2,373 | 🌐 Rust | 📅 2026-03-26 - A high-performance observability data pipeline.
...
* [tera](https://github.com/Keats/tera) ⭐ 4,165 | 🐛 193 | 🌐 Rust | 📅 2025-12-11 - A template engine for Rust based on Jinja2/Django.
...
* [AutoCorrect](https://github.com/huacnlee/autocorrect) ⭐ 1,574 | 🐛 9 | 🌐 Rust | 📅 2026-03-23 - A linter and formatter to help you to improve copywriting, correct spaces, words, and punctuations between CJK (Chinese, Japanese, Korean).
...
* [PTA-Parser](https://github.com/AltaModaTech/pta-parser/) ⭐ 1 | 🐛 0 | 🌐 Rust | 📅 2024-06-10 - A Plain Text Accounting parser built in Rust for [Beancount](https://github.com/beancount/beancount) ⭐ 5,409 | 🐛 229 | 🌐 Python | 📅 2026-03-23, [Ledger](https://github.com/ledger/ledger) ⭐ 5,893 | 🐛 214 | 🌐 C++ | 📅 2026-03-26, and other PTA formats.
